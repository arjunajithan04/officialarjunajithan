...
const Contact = () => {
  ...
  const availabilityStatus = contact.availability_status.trim() || "AVAILABLE";
      ...
      <div className="contact-v3-shell">
        ...
        <div className="contact-v3-hero">
          <motion.div
            ...
            transition={{ duration: 0.95, ease: contactEase }}
          >
          ...
          <motion.div
            ...
            viewport={{ once: false, amount: 0.2 }}
            transition={{ duration: 0.8, delay: 0.14, ease: contactEase }}
          >
        ...
        >
          ...
          <div className="contact-v3-email-row">
            <a href={`mailto:${contact.email}`} className="contact-v3-email">
              {contact.email}
            </a>
